...
import com.teebay.appname.databinding.FragmentMyRentBinding
...
import com.teebay.appname.features.myOrders.viewModel.MyRentViewModel
import com.teebay.appname.network.ResponseState
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class MyRentFragment : Fragment() {
    private var binding: FragmentMyRentBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentMyRentBinding.inflate(inflater, container, false)
        return binding?.root
    }
